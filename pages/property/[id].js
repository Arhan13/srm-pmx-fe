...
const PropertyDetails = ({ propertyDetails: { isVerified } }) => {
  ...
  let tableData = [
    { tissue: "ICV", units: "cm3", quantity: "1369.66" },
    { tissue: "Whole Brain", units: "cm3", quantity: "970.85" },
    { tissue: "White Matter", units: "cm3", quantity: "542.50" },
    { tissue: "Grey Matter", units: "cm3", quantity: "428.35" },
    { tissue: "CSF", units: "cm3", quantity: "398.80" },
  ];
